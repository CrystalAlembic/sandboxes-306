...
<img width="1100" height="816" alt="sandboxed-demo" src="https://github.com/CrystalAlembic/sandboxes-306/f794ff9b-8ffe-47e8-bd30-22541f870f09" />
...
```bash
git clone https://github.com/CrystalAlembic/sandboxes-306.git
cd sandboxes-306
python setup.py
```
...
<!-- Last updated: 2026-06-05 13:41:10 -->
